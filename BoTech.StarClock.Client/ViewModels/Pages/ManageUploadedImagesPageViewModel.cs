...
{
    public ObservableCollection<UploadedImageViewModel> UploadedImages { get; set; }
    ...
    {
        UploadedImages = new ObservableCollection<UploadedImageViewModel>();
        _deviceInfo = model;
    ...
    private void ReloadAllImages()
    {
        ...
        progressVm.Action = ReloadAllImagesAction;
